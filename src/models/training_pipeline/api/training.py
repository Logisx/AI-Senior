...
class TrainingAPI:
    ...
    def from_config(
        cls,
        model_params: ConfigurationManagement.get_model_params(),
        training_arguments: ConfigurationManagement.get_training_arguments(),
        root_dataset_dir: Path,
        ...
        return cls(
            ...
            model_id=model_params.base_model_name,
            template_name=model_params.template,
